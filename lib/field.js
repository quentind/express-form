    ...
    function runStack(foo) {
      ...
      stack.forEach(function (proc) {
        ...
        if (result.error) {
          ...
          if (!utils.hasValue(value) && !self.__required && !self.__required_tmp) return;
...
Field.prototype.requiredIf = function (fn, placeholderValue, message) {

  var self = this;

  return this.add(function (value, source) {

    if ( fn( value, source) === true ) {
      self.__required_tmp = true;
    }
